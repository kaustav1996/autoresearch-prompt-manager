...
async def handle_support_requests(
    ...
    tasks = [
        ...
        "A customer is very frustrated — their order has been "
        "delayed 3 times and they want a refund",
        "Decide whether to escalate: customer claims a bug "
        "caused data loss affecting their business",
    ]
